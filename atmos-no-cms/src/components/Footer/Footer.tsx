        ...
        <div className={styles.top}>
          ...
          <div className={styles.leftCol}>
            ...
            <ul className={styles.socials} aria-label="Social media">
              ...
              <li><a className="social__link" href="https://www.instagram.com/atmosledco/" target="_blank" rel="noreferrer" aria-label="Instagram">
                <svg className="social__icon" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <nav className={styles.rightCol} aria-label="Footer">
            <ul className={styles.menu}>
              ...
              <li><a href="https://mapoutcreative.com/calculator/" target="_blank">Calculator</a></li>
              <li><a href="https://dfuc15-ke.myshopify.com" target="_blank">Store</a></li>
            </ul>
          </nav>
        </div>
